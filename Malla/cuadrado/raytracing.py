...
def mesh_triangles(P, color):
    meshtriangles = [add_triangle(P[0], P[1], P[2], color)]
    i = 3
    
    while i<len(P):
        if i%2==0:
            meshtriangles = meshtriangles + [add_triangle(P[i], P[i-2], P[i-1], color)]
        else:
            meshtriangles = meshtriangles + [add_triangle(P[i], P[i-1], P[i-2], color)]
        i += 1
...
triangles = mesh_triangles([[-1.,-0.5,1],[-1,0.5,1],[0.,-0.5,1],[0.,0.5,1]], [0.,1.,1.])
